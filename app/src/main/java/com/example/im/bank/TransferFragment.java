    ...
    private void confirmTransfer() {
        ...
        if (isNum) {
            if (transferAmount>2000){
                Toast.makeText(getActivity(),"never above 2000DH",Toast.LENGTH_SHORT).show();
            }
          else  if (spnSendingAccount.getSelectedItemPosition() == receivingAccIndex) {
                ...
                Toast.makeText(getActivity(), "Transfer of MAD" + String.format(Locale.getDefault(), "%.2f",transferAmount) + " successfully made", Toast.LENGTH_SHORT).show();
            }
        }
    }
