...
public class CreateProfileFragment extends Fragment {
    ...
    private void createProfile() {
        ...
        if (edtFirstName.getText().toString().equals("") || edtLastName.getText().toString().equals("") || edtPhone.getText().toString().equals("") ||
            ...
            Profile userProfile = new Profile(edtFirstName.getText().toString(), edtLastName.getText().toString(), edtPhone.getText().toString(),
