...
import com.example.im.bank.AccountOverviewFragment;
import com.example.im.bank.DashboardFragment;
import com.example.im.bank.LaunchActivity;
import com.example.im.bank.Model.Account;
import com.example.im.bank.Model.Profile;
import com.example.im.bank.Model.db.ApplicationDB;
import com.example.im.bank.PaymentFragment;
import com.example.im.bank.R;
import com.example.im.bank.TransferFragment;
...
public class DrawerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void manualNavigation(manualNavID id, Bundle bundle) {
        ...
        if (id == manualNavID.DASHBOARD_ID) {
            ft.replace(R.id.flContent, new com.example.im.bank.DashboardFragment()).commit();
            navView.setCheckedItem(R.id.nav_dashboard);
            setTitle("Dashboard");
        } else if (id == manualNavID.ACCOUNTS_ID) {
            com.example.im.bank.AccountOverviewFragment accountOverviewFragment = new com.example.im.bank.AccountOverviewFragment();
            if (bundle != null) {
    ...
    private void makeDeposit() {
        ...
        if (depositAmount < 0.01 && !isNum) {
            ...
            Toast.makeText(this, "Deposit of MAD" + String.format(Locale.getDefault(), "%.2f",depositAmount) + " " + "made successfully", Toast.LENGTH_SHORT).show();
    ...
    public void displayHelpDialog() {
        ...
        builder.setTitle("Help")
                .setMessage("this dialog will give the user help, depending on where they are in the app");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()) {
            case R.id.nav_dashboard:
                fragmentClass = com.example.im.bank.DashboardFragment.class;
                break;
